...
{
    [Activity(Label = "UserManagemetnActivity")]
    public class UserManagemetnActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.usermanagement_layout);
        ...
        private void FetchUsersFromDB()
        {
            ...
            FireBaseHelper.FirestoreEventListener.getEvent += (error, args) =>
            {
                ...
                {
                    Log.Debug(ProManager.TAG, $"fetch user from db faild:{0}", ex.Message);
                }
            };
        }
